...
export type Settings = { materialWidthMm: number; clearanceMm: number; timeLimitSeconds: 10 | 30 | 60 | 120 };
...
export const DEFAULT_SETTINGS: Settings = { materialWidthMm: 1000, clearanceMm: 0, timeLimitSeconds: 30 };
...
export function example(): Document {
  const shapes: Ring[] = [ [[0,0],[36,0],[36,12],[12,12],[12,38],[0,38]],
    ...
    [[0,0],[30,0],[30,30],[0,30]] ];
  return { name: 'Workshop parts', settings: { materialWidthMm: 100, clearanceMm: 0, timeLimitSeconds: 10 },
